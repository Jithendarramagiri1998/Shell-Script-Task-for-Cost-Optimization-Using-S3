...
# Variables
JENKINS_HOME="/var/lib/jenkins"  # Replace with your Jenkins home directory # Replace with your Jenkins home directory
S3_BUCKET="s3://jithendar"  # Replace with your S3 bucket name  # Replace with your S3 bucket name
